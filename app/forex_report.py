...
<div style="background:#172554;color:white;border-radius:16px;padding:24px"><div style="font-size:12px;opacity:.8">FOREX INTELLIGENCE • {html.escape(stamp)}</div><h1 style="margin:8px 0">Production Forex Dashboard</h1><div style="font-size:22px;font-weight:bold;margin:4px 0 14px">Bryne and Lot-Bill Strategy • Paper Experiment</div><span style="display:inline-block;background:{status_color};padding:8px 14px;border-radius:999px;font-weight:bold">{mode} • {"READY" if ready else "NOT READY"}</span></div>
