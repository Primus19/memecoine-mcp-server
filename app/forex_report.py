...
<div style="background:#e0f2fe;border:2px solid #38bdf8;border-radius:12px;padding:18px;margin-bottom:14px;overflow-x:auto"><h2 style="color:#075985">Live Control Strategy • Auditable positions and intents</h2><table style="border-collapse:collapse;width:100%;font-size:13px"><tr><th>Created</th><th>Pair</th><th>Side</th><th>Mode</th><th>Status</th><th>Score</th><th>Entry</th><th>Stop</th><th>Target</th><th>Max loss</th><th>Main reason for entry</th><th>Realized P&amp;L</th></tr>{rows(intent_rows, [("created","Created"),("symbol","Pair"),("side","Side"),("mode","Mode"),("status","Status"),("score","Score"),("entry","Entry"),("stop","Stop"),("target","Target"),("risk","Max loss"),("reason","Entry reason"),("pnl","P&amp;L")], background="#f0f9ff")}</table></div>
